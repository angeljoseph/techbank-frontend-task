...
>
  <SwiperSlide v-for="(p, i) in columns" :key="i">
...
<style scoped>
.products-section { padding: 64px 16px; display:flex; justify-content:center;text-align:center }
...
.product-footer { display:flex; gap:16px; padding: 25px; align-items:center; justify-content:space-between }
